...
c <- ggplot(year_averages_pol, aes(x = affrmact_avg, y = discaff_avg, color= haven::as_factor(polviews))) + 
  geom_point(size = 3) + 
  ...
  ggtitle("Correlation between different views on Affirmative Action, by Political Leaning") + 
  scale_color_brewer(palette = "Dark2", name = "Political Views") + 
  theme_bw(12)
c
```
...
d <- ggplot(year_averages_by, aes(x=birthyear, fill=haven::as_factor(affrmact))) +
  geom_bar(position="fill") + 
  theme_bw(12) + 
  scale_fill_brewer(palette = "Set1", name = "Opinion on Affirmative Action") + 
...
a <- gss_d |>
  ...
  scale_color_brewer(name = "Opinion on Affirmative Action", palette = "Set1") + 
