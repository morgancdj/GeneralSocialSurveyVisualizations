...
Before we start data analysis, we first load the data and the variables we are interested in. The data can be easily accessed through the `gssr` package. We select the following demogrhic variables for our analysis: 
