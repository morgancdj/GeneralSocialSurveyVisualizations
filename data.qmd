...
Below is a graph showing the percentage of missing values in each of the abortion-related variables we investigate in our analysis. Note that all the variables have a high percentage of missing values around 45% for "abrtion for any reason" and around 35% for all other variables. Additionally, note that most of the missing values are inapplicable responses with over 90% of all missing values being inapplicable responses.

any reason	45.76			
rape	35.78			
financial hardship	35.67			
not married	35.66			
married-no more children	35.60			
birth defect	35.48			
mother's health	35.17	
